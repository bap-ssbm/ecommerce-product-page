...
function CartBasket(props) {
    ...
    const isempty = props.userCart.length === 0;
    ...
    function MapIfNotEmpty() {
        return (
            <div className="non-empty-basket">
                <div className="cart-items-sections">

                    <div className="cart-basket-items">
                        {props.userCart.map(mapItems)}
    ...
    return (
        <div className="cart-basket">
            <div className="top-baseket-section">
                <h1 className="cart-title">Cart</h1>
            </div>
           {isempty?<MapIfEmpty/>:<MapIfNotEmpty/>}
